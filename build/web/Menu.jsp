    ...
    <!-- Navbar Start -->
            ...
            <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
                <nav class="navbar navbar-expand-lg bg-white navbar-light shadow p-lg-0">
                    <a href="Home.jsp" class="navbar-brand d-block d-lg-none">
                        <h1 class="m-0 display-4"><span style="color: #F195B2;">C&R</span>Sorveteria</h1>
                    </a>
                            ...
                            <ul class="navbar-nav"> 
                                <li class="nav-item dropdown"><a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Relatorios</a>
                                    <ul class="dropdown-menu"> 
                                        ...
                                        <li><a target="blank"href="RelatorioCliente.jsp" class="dropdown-item text-dark" data-bs-toggle="modal" data-bs-target="#relatorioCliente">Relatorio Cliente</a></li> 
                                        ...
                                        <li><a target="blank"href="RelatorioProduto.jsp" class="dropdown-item text-dark" data-bs-toggle="modal" data-bs-target="#relatorioProduto">Relatorio Produto</a></li> 
                                        <li><a target="blank"href="RelatorioTurno.jsp" class="dropdown-item text-dark">Relatorio Turnos</a></li> 
                                        <li><a target="blank"href="RelatorioVenda.jsp" class="dropdown-item text-dark" data-bs-toggle="modal" data-bs-target="#relatorioVenda">Relatorio Venda</a></li> </ul> 
                                </li>
                            </ul>
       ...
       <!--Relatorio Funcionario -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-primari">
                    ...
                    <div class="modal-body">
                        <form id="relatorioForm" action="RelatorioFuncionario.jsp" method="post" onsubmit="return validarFormulario()">
                            <div class="mb-3">
                            ...
                            <button style="background-color: #F195B2;" type="submit" class="btn mt-3 px-4 fw-bold text-white">Gerar Relatório</button>                   
        ...
        <!--Relatorio Cliente -->
            <div class="modal fade" id="relatorioCliente" tabindex="-1" aria-labelledby="relatorioClienteLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-primari">
                        <h5 class="modal-title fw-bold text-white" id="relatorioClienteLabel">Relatório Cliente</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="relatorioForm" action="RelatorioCliente.jsp" method="post" >
                            <div class="mb-3">
                                <label for="idadeMinima" class="form-label">Idade Mínima:</label>
                                <input type="text" class="form-control" id="idadeMinima" name="idadeMinima">
                            </div>
       ...
       <script> 
            function validarFormulario() {
                ...
                var idadeMinima = document.getElementById("idadeMinima").value;
                var idadeMaxima = document.getElementById("idadeMaxima").value;
                // Validar se os campos estão em branco
                if (idadeMinima.trim() === "" || idadeMaxima.trim() === "") {
                    alert("Por favor, preencha todos os campos.");
                    return false; // Impedir o envio do formulário
                }
                // Validar se os campos contêm apenas números
                if (!/^[\d]+$/.test(idadeMinima) || !/^[\d]+$/.test(idadeMaxima)) {
                    alert("Por favor, insira apenas números nos campos de idade.");
                    return false; // Impedir o envio do formulário
                }
        ...
        <!--Relatorio Produto -->
            <div class="modal fade" id="relatorioProduto" tabindex="-1" aria-labelledby="relatorioProdutoLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-primari">
                        <h5 class="modal-title fw-bold text-white" id="relatorioProdutoLabel">Relatório Personalizado Produto</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="relatorioForm" action="RelatorioProduto.jsp" method="post" > <!onsubmit="return validarFormulario()"->
                            <div class="mb-3">
                                <label for="PrecoMinimo" class="form-label">Preço de Venda mínimo:</label>
                                <input type="text" class="form-control" id="PrecoMinimo" name="PrecoMinimo">
                            </div>
                            <div class="mb-3">
                                <label for="PrecoMaximo" class="form-label">Preço de Venda máximo:</label>
                                <input type="text" class="form-control" id="PrecoMaximo" name="PrecoMaximo">
                            </div>
         ...
         <!--Relatorio Venda -->
         <div class="modal fade" id="relatorioVenda" tabindex="-1" aria-labelledby="relatorioVendaLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-primari">
                        <h5 class="modal-title fw-bold text-white" id="relatorioVendaLabel">Relatório Personalizado Venda</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form id="relatorioForm" action="RelatorioVenda.jsp" method="post" > <!onsubmit="return validarFormulario()"->
                            <div class="mb-3">
                                <label for="Diaminimo" class="form-label">Coloque uma data inicial</label>
                                <input type="date" class="form-control" id="Diaminimo" name="Diaminimo">
                            </div>
                            <div class="mb-3">
                                <label for="Diamaximo" class="form-label">Coloque uma data final</label>
                                <input type="date" class="form-control" id="Diamaximo" name="Dia">
                            </div>
