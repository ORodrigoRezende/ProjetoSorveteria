<%-- 
    Document   : RelatorioCategoria
    Created on : 24/10/2023, 15:57:22
    Author     : 12678776697
--%>
...
<%
  ...
  ResultSet rs = rel.relatorioCategoria();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioCategoria.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há categoria cadastrado, para cadastrar um categoria clique no menu CADASTRO > Categoria." />
</jsp:forward>
