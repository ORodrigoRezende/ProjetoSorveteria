...
String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioFuncionario.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há funcionario cadastrado, para cadastrar um funcionario clique no menu CADASTRO > Funcionario." />
</jsp:forward>
