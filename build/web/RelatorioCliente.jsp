...
<%
    ...
    ResultSet rs = rel.relatorioCliente(idadeMinima1, idadeMaxima2);

                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioCliente.jasper";
