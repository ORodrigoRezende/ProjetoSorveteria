...
String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioFornecedor.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há fornecedor cadastrado, para cadastrar um fornecedor clique no menu CADASTRO > Fornecedor." />
</jsp:forward>
