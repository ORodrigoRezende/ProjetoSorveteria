<%-- 
    Document   : RelatorioTurno
    Created on : 24/10/2023, 15:59:14
    Author     : 12678776697
--%>
...
<%
  ...
  ResultSet rs = rel.relatorioTurno();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioTurno.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há turno cadastrado, para cadastrar um Turno clique no menu CADASTRO > Turno." />
</jsp:forward>
