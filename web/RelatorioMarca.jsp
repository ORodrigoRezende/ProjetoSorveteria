<%-- 
    Document   : RelatorioMarca
    Created on : 24/10/2023, 15:59:59
    Author     : 12678776697
--%>
...
<%
  ...
  ResultSet rs = rel.relatorioMarca();
                if (rs.next()) {
                    rs.beforeFirst();


String caminho = "C:/Users/orodr/OneDrive/Área de Trabalho/IF/Projeto Sorveteria/Projeto Sorveteria/web/Relatorio/RelatorioMarca.jasper";
...
<jsp:forward page="Mensagem.jsp">
    <jsp:param name="mensagem" value="Não há marca cadastrada, para cadastrar uma marca clique no menu CADASTRO > Marca." />
</jsp:forward>
